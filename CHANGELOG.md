...
- Add per-request opaque-correlation controls and a client `opaque_correlation_request_only` mode
  for opt-in rollouts, with eager PRNG initialization and unchanged unflagged reads. (mrattle)
